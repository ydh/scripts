...
#  internal-k8s-apiserver-463791052.us-west-1.elb.amazonaws.com为ELB,不加会造成kubelet在请求apiserver时候报证书错误
cat <<EOF > kube-apiserver.json
{
    ...
    "hosts": [
        ...
        "172.31.21.119",
        "10.254.0.1",
        "internal-k8s-apiserver-463791052.us-west-1.elb.amazonaws.com",
        "kubernetes",
        "kubernetes.default",
